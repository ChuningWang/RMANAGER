#!/bin/bash
#
# svn $Id: build.bash 646 2013-01-22 23:35:19Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
export        MY_ROOT_DIR=/glade/u/home/chuning/roms
  ...
  case "$FORT" in
    ifort )
      ...
      if [ -n "${USE_NETCDF4:+1}" ]; then
        ...
        export     NETCDF_INCDIR=/opt/modeling/libs/netcdf/3.6.2/intel/14.0.0/include
        export     NETCDF_LIBDIR=/opt/modeling/libs/netcdf/3.6.2/intel/14.0.0/lib
      fi
      ;;
    ...
    gfortran )
      ...
      if [ -n "${USE_NETCDF4:+1}" ]; then
        if [ -n "${USE_PARALLEL_IO:+1}" ] && [ -n "${USE_MPI:+1}" ]; then
          ...
          # TO DO either module load 
          export       NC_CONFIG=nf-config
          export   NETCDF_INCDIR=$( nf-config --includedir )
        fi
      else
        export     NETCDF_INCDIR=/opt/modeling/libs/netcdf/3.6.2/gcc/4.4.7/include
        export     NETCDF_LIBDIR=/opt/modeling/libs/netcdf/3.6.2/gcc/4.4.7/lib
      fi
      ;;
...
# Put the binary to execute in the following directory.
 ...
 export            BINDIR=/glade/scratch/chuning/tmpdir_UPWELLING_TESTINSTALL

# Put the f90 files in a project specific Build directory to avoid conflict
# with other projects.

 export       SCRATCH_DIR=${BINDIR}/Build

# RMANAGER Specific
# write loaded modules into a file both in config dir and rundir

 module list > ./modules-used 2>&1
 module list > $BINDIR/modules-used 2>&1
